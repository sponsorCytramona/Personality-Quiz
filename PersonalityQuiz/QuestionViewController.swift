...
class QuestionViewController: UIViewController {
    ...
    // MARK: Actions
    @IBAction func singleViewButtonPressed(_ sender: UIButton) {
    ...
    var questions: [Question] = [
        Question(text: "Which of wood do you like the most?", type: .single, answers: [
    ...
    func updateUI() {
        ...
        case .ranged:
            updateRangetStack(using: currentAnswer)
        }
        ...
        func updateRangetStack(using answers: [Answer]) {
